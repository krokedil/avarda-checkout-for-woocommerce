...
$settings = array(
	...
	'general'                    => array(
		'id'          => 'general',
		'title'       => __( 'General configuration', 'avarda-checkout-for-woocommerce' ),
		'type'        => 'krokedil_section_start',
		'description' => __( 'Get started with Avarda Checkout by configuring the general settings for the plugin.', 'avarda-checkout-for-woocommerce' ),
	),
	'enabled'                    => array(
	...
	'shipping'                   => array(
		...
		'type'        => 'krokedil_section_start',
		'description' => __( 'Configure the shipping integration in Avarda Checkout.', 'avarda-checkout-for-woocommerce' ),
	),
	...
	'credentials'                => array(
		'id'          => 'credentials',
		'title'       => __( 'Credentials', 'avarda-checkout-for-woocommerce' ),
		'description' => __( 'Enter the API credentials you received from Avarda. You need to enter credentials for each country you want to offer Avarda Checkout in.', 'avarda-checkout-for-woocommerce' ),
		'type'        => 'krokedil_section_start',
	),
	// SE.
