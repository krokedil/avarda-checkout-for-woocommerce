...
== CHANGELOG ==
= 2026.05.28        - version 1.17.7 =
* Fix               - Resolved checkout validation errors with WooCommerce 10.8+ by populating shipping phone and email fields before form submission.

= 2026.05.04        - version 1.17.6 =
* Enhancement       - Updated the settings UI for improved usability.
* Tweak             - Logging is now enabled by default.
* Fix               - Ensured payment-processing error messages are displayed correctly after recent WooCommerce changes.

= 2025.12.16        - version 1.17.5 =
* Fix               - Fixed not supporting some types of Subscription payments.
* Fix               - Fixed and issue when calculating shipping prices for shipping broker integrations.
...
= 2025.09.01        - version 1.17.2 =
* Fix               - Resolved an issue with hook priority that could cause an Avarda JWT token error in checkout.
* Fix               - Resolved a '_load_textdomain_just_in_time' notice.
* Tweak             - The integrated shipping options are now sorted by price (lowest to highest).
* Tweak             - Tweaked the design of the shipping widget.
* Tweak             - Renamed the Avarda metabox setting 'Order synchronization' to 'Order Management'.
